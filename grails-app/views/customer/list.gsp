			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="userID" title="${message(code: 'customer.userID.label', default: 'User ID')}" />
						...
						<g:sortableColumn property="referredByUser" title="${message(code: 'customer.referredByUser.label', default: 'Referred By User')}" />
				...
				<g:each in="${customerInstanceList}" status="i" var="customerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${customerInstance.id}">${fieldValue(bean: customerInstance, field: "userID")}</g:link></td>
					
						<td>${fieldValue(bean: customerInstance, field: "userName")}</td>
					
						<td>${fieldValue(bean: customerInstance, field: "email")}</td>
					
						<td>${fieldValue(bean: customerInstance, field: "referredByUser")}</td>
